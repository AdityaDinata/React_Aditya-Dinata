...
import { article } from './article'; // pastikan untuk menyesuaikan jalur impor
...
const Icon = () => {
  ...
  const toggleLanguage = () => {
    setLanguage((prevLang) => (prevLang === 'en' ? 'id' : 'en')); // Toggle bahasa
  };
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <h1 className="text-3xl mt-4 flex justify-center font-bold">{article.title[language]}</h1>
      ...
      <div className="flex justify-center space-x-4 mt-4">
        ...
        <button onClick={toggleLanguage} className="bg-gray-500 text-white py-2 px-4 rounded">
